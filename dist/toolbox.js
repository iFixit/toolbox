...
var color = exports.color = {
   ...
   red: ['#FDEEEC', '#FBDED9', '#F8BDB4', '#F07B69', '#E83014', '#A11601', '#610B00'],
   ...
   grayAlpha: ['rgba(0, 3, 6, 0.02)', 'rgba(0, 3, 6, 0.04)', 'rgba(0, 3, 6, 0.07)', 'rgba(0, 3, 6, 0.12)', 'rgba(0, 3, 6, 0.26)', 'rgba(0, 3, 6, 0.38)', 'rgba(0, 3, 6, 0.54)', 'rgba(0, 3, 6, 0.61)', 'rgba(0, 3, 6, 0.74)', 'rgba(0, 3, 6, 0.87)'],
   whiteAlpha: ['rgba(255, 255, 255, 0.25)', 'rgba(255, 255, 255, 0.5)', 'rgba(255, 255, 255, 0.75)', 'rgba(255, 255, 255, 0.97)'],
   white: '#FFFFFF',
   black: '#000000'
};

var spacing = exports.spacing = ['0.25rem', '0.5rem', '1rem', '2rem', '4rem', '8rem', '16rem'];

var fontSize = exports.fontSize = ['0.75rem', '0.875rem', '1rem', '1.25rem', '1.5rem', '2.25rem', '3rem', '5rem', '6rem'];
...
var _glamorous = __webpack_require__(5);

var _glamorous2 = _interopRequireDefault(_glamorous);

var _featherIcons = __webpack_require__(47);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var SvgContainer = _glamorous2.default.span({
...
var Icon = function Icon(props) {
   return _react2.default.createElement(SvgContainer, {
      className: props.className,
      size: props.size,
      color: props.color,
      strokeWidth: props.strokeWidth,
      dangerouslySetInnerHTML: {
         __html: (0, _featherIcons.toSvg)(props.name, {
            width: '100%',
            height: '100%',
...
var ButtonContainer = _glamorous2.default.button({
   display: 'inline-block',
   fontFamily: 'inherit',
   fontSize: _constants.fontSize[1],
   lineHeight: _constants.lineHeight.copy,
   textAlign: 'center',
   textDecoration: 'none',
   border: '1px solid',
   ...
   outline: 'none',
   cursor: 'pointer',
   transition: 'all ' + _constants.transition.duration + ' ' + _constants.transition.easing
}, function (_ref) {
   ...
   switch (design) {
      case 'primary':
         return {
            color: _constants.color.white,
            backgroundColor: _constants.color.blue[4],
            borderColor: _constants.color.blue[4],
            ':hover': {
               backgroundColor: _constants.color.blue[5],
               borderColor: _constants.color.blue[5]
            },
            ':focus': {
               boxShadow: '0 0 0 3px ' + _constants.color.blue[2]
            }
         };

      case 'outline':
         return {
            color: _constants.color.blue[4],
            backgroundColor: transparent ? 'transparent' : _constants.color.white,
            borderColor: _constants.color.blue[2],
            ':hover': {
               color: _constants.color.white,
               backgroundColor: _constants.color.blue[4],
               borderColor: _constants.color.blue[4]
      ...
      default:
         return {
            color: _constants.color.grayAlpha[9],
            backgroundColor: transparent ? 'transparent' : _constants.color.white,
            borderColor: _constants.color.grayAlpha[3],
            ':hover': {
               backgroundColor: transparent ? _constants.color.grayAlpha[0] : _constants.color.gray[0],
               borderColor: _constants.color.grayAlpha[4]
            },
            ':focus': {
               boxShadow: '0 0 0 3px ' + _constants.color.grayAlpha[3]
            }
         };
   }
}, function (_ref2) {
   ...
   switch (size) {
      case 'small':
         return {
            padding: _constants.spacing[0] + ' ' + _constants.spacing[1]
         };

      case 'large':
         return {
            fontSize: _constants.fontSize[2],
            lineHeight: _constants.lineHeight.title,
            padding: _constants.spacing[2] + ' ' + _constants.spacing[3]
         };

      default:
         return {
            padding: _constants.spacing[1] + ' ' + _constants.spacing[2]
         };
   }
}, function (_ref3) {
   ...
   if (disabled) {
      return {
         color: _constants.color.grayAlpha[5],
         backgroundColor: _constants.color.grayAlpha[1],
         borderColor: _constants.color.grayAlpha[3],
         pointerEvents: 'none'
      };
   }
...
var LinkContainer = ButtonContainer.withComponent('a');

var Button = function Button(_ref5) {
   var children = _ref5.children;

   var props = _objectWithoutProperties(_ref5, ['children']);

   var Container = props.href === '' ? ButtonContainer : LinkContainer;
...
Button.propTypes = {
   ...
   design: _propTypes2.default.oneOf(['default', 'primary', 'outline']),
...
var TagContainer = _glamorous2.default.span({
   display: 'inline-flex',
   alignItems: 'stretch',
   padding: 0,
   fontFamily: 'inherit',
...
var TagText = _glamorous2.default.span({
   padding: _constants.spacing[0] + ' ' + _constants.spacing[0] + ' ' + _constants.spacing[0] + ' ' + _constants.spacing[1]
});

var TagRemove = _glamorous2.default.button({
   padding: _constants.spacing[0],
   lineHeight: 0,
   color: _constants.color.white,
   ...
   outline: 'none',
   '&:hover': {
      backgroundColor: _constants.color.grayAlpha[3]
   },
   '&:focus': {
      backgroundColor: _constants.color.grayAlpha[5]
   }
});
...
var Tag = function Tag(props) {
   return _react2.default.createElement(
      ...
      _react2.default.createElement(
         ...
         _react2.default.createElement(_Icon2.default, { name: 'x', size: 16 })
      )
   );
};
...
var Label = _glamorous2.default.label({
   display: 'inline-block',
...
var LabelText = _glamorous2.default.span({
   display: 'inline-block',
   marginBottom: _constants.spacing[2],
   lineHeight: _constants.lineHeight.solid
});
...
var Input = _glamorous2.default.input({
   ...
   fontSize: _constants.fontSize[2],
   lineHeight: _constants.lineHeight.copy,
   border: '1px solid ' + _constants.color.grayAlpha[3],
   borderRadius: _constants.borderRadius,
   outline: 'none',
   ':focus': {
      borderColor: _constants.color.blue[4],
      boxShadow: '0 0 0 1px ' + _constants.color.blue[4]
   }
}, function (_ref2) {
   var disabled = _ref2.disabled;
   return {
      color: disabled ? _constants.color.grayAlpha[5] : _constants.color.grayAlpha[9],
      backgroundColor: disabled ? _constants.color.grayAlpha[1] : _constants.color.white
   };
});
   ...
   return _react2.default.createElement(
      ...
      _react2.default.createElement(Input, {
         ...
         onChange: function onChange(ev) {
            return props.onChange({ value: ev.target.value });
         },
...
TextField.propTypes = {
   ...
   type: _propTypes2.default.oneOf(['text', 'email', 'number', 'password', 'tel', 'search', 'url', 'date', 'datetime-local', 'month', 'week', 'time']),
